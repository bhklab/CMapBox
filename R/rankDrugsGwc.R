...
rankDrugsGwc = function(geneIds, geneEsts, pvals = NULL, drugPert = NULL, 
                        pharmSet = NULL, drugScoreMeth = "gwcCmapBox", 
                        pCut = TRUE, cutOff = 0.05, genesToStart = 0.20, 
                        numbIters = 10, gwcMethod = "spearman", numbPerms = 1000, 
                        volcPlotEsts = NA, drugEst = TRUE, inspectResults = TRUE, 
                        showMimic = FALSE, mDataType = "rna", extraData = NA, 
                        extraCut = NA, extraDirec = NA)
{
