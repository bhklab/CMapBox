...
#' seeDrugImpactGenes(drugPert = drugPertEx, pharmSet = cmapSmall, mDataType = "rna", drugName = "Prestwick-675", genesOfInt = drivingGenes)
#' 

seeDrugImpactGenes = function(drugPert, pharmSet, mDataType, drugName, genesOfInt)
{
